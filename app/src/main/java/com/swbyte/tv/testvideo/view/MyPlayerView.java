package com.swbyte.tv.testvideo.view;
...
import com.swbyte.tv.testvideo.R;
...
public final class MyPlayerView extends FrameLayout {
    ...
    private final MyPlayerView.ComponentListener componentListener;
    ...
    public MyPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        componentListener = new MyPlayerView.ComponentListener();
    ...
    public void setControllerVisibilityListener(MyPlayerControlView.VisibilityListener listener) {
        Assertions.checkState(controller != null);
        controller.setVisibilityListener((PlayerControlView.VisibilityListener) listener);
    }
